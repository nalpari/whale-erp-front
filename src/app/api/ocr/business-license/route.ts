...
반드시 아래 JSON 형식으로만 응답하세요:
{
  ...
  "address1": "사업장 소재지에서 첫 번째 쉼표(,) 앞 부분 (시/도 ~ 도로명/번지)",
  "address2": "사업장 소재지에서 첫 번째 쉼표(,) 뒷 부분 (건물명, 호수 등). 쉼표가 없으면 null",
...
- 사업장 소재지는 첫 번째 쉼표(,)를 기준으로 address1과 address2로 분리. 쉼표가 없으면 전체를 address1에 넣고 address2는 null
